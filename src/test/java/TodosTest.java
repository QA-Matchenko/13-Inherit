...
class TodosTest {
    ...
    public void testSearchFewTasks() {
        ...
        Tasks[] expected = {simpleTask, epic};
        Tasks[] actual = todos.search("Хлеб");
        Assertions.assertArrayEquals(expected, actual);
    }
    @Test
    public void testSearchNoTasks() {
        ...
        Tasks[] expected = {};
        Tasks[] actual = todos.search("Позвонить");
        Assertions.assertArrayEquals(expected, actual);
    }
    @Test
    public void testSearchOneTask() {
        ...
        Tasks[] expected = {meeting};
        Tasks[] actual = todos.search("Во вторник");
        Assertions.assertArrayEquals(expected, actual);
    }
}